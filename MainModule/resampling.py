...
def smotenc(data: pd.DataFrame, desired_size: int, categorical_features, random_state: int):
    ...
    # Calling smotenc on these data will increase the size of the original data (class 1) to
